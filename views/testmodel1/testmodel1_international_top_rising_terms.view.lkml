# The name of this view in Looker is "Testmodel1 International Top Rising Terms"
view: testmodel1_international_top_rising_terms {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `testmodel1.international_top_rising_terms` ;;
