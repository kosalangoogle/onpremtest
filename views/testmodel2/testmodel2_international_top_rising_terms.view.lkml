# The name of this view in Looker is "Testmodel2 International Top Rising Terms"
view: testmodel2_international_top_rising_terms {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `testmodel2.international_top_rising_terms` ;;
